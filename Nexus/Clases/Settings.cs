...
namespace Nexus.Clases
{
    public class Settings
    {
        ...
        public string delete_user_settings(string cwid, string id_dashboard)
        {
            var msg = "";
            try
            {
                ...
                using (var conn = new SqlConnection(constr))
                {
                    SqlCommand cmd = new SqlCommand("delete_user_settings", conn);
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public string insert_user_settings(string cwid, string id_dashboard)
        {
            var msg = "";
            try
            {
                ...
                using (var conn = new SqlConnection(constr))
                {
                    SqlCommand cmd = new SqlCommand("insert_user_settings", conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@cwid ", SqlDbType.VarChar).Value = cwid;
                    cmd.Parameters.Add("@id_dashboard", SqlDbType.Int).Value = id_dashboard;
