...
namespace Nexus.Clases
{
    ...
    {
        public string insert_ordenes_trabajo(DataTable TabOrdenes)
        {
            var msg = "";
            try
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("insert_ordenes_trabajo", conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@TabOrdenes", TabOrdenes);
        ...
        public int get_TotalPag_ordenes_trabajo(string orden, int PageSize)
        {
            ...
            try
            {
                ...
                sql.CommandText = "select dbo.get_TotalPag_ordenes_trabajo(" + (orden == "" || orden == null ? (object)DBNull.Value + "null" : ("'" + orden + "'")) +
                    "," + PageSize + ");";
                sql.Connection = con;
        ...
        public DataTable get_ordenes_trabajo_table(string orden, int PageIndex, int PageSize)
        {
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["BD_Base"].ConnectionString);
            var msg = "";
            DataTable dt = new DataTable();
            try
            {
                using (con)
                {
                    SqlCommand cmd = new SqlCommand("get_ordenes_trabajo_table", con);
                    cmd.Parameters.Add("@orden", SqlDbType.VarChar).Value = orden == "" || orden == null ? (object)DBNull.Value : orden;
